...
class Locations(Resource):
    """
    Async resource for location-related endpoints.
    ...
    async def get(self, location_id: int) -> Location:
        ...
        """
        response = await self._client._request("GET", f"/locations/{location_id}")
    ...
    async def get_season(self, season_id: str) -> LeagueSeason | LeagueSeasonV2:
